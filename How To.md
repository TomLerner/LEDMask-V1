I got inspired to develop this project after seeing a year old post on Reddit’s Arduino sub-reddit by /u/l30. At that point I had no experience with micro-controllers or electronics and it’s been years since I’ve done any programming, however /u/l30’s engagement in the comment section, fielding questions on how he created his mask, gave me a sense that I could do it myself.

To create a foundation I decided to purchase the “Arduino Starter Kit for beginner”. The book explained the basics of the electronics, provided a good way to refresh my programming skills, and taught me how to create an electrical circuit board, which was my biggest concern starting out.

As I felt ready to develop my own mask, I reached out to /u/l30 and asked for some advice. He was able to point me out to a tutorial developed by Armaiz Adenwala demonstrating how to build his own version of a mask with schematics and code included. 
...
Arduino Nano ATmega238P

WS2812B LED flexible strip with waterproof silicon cover

PCB Board that I resized to fit the project box

10K ohm Potentiometer for brightness control

Momentary Push Button for animation control

470 ohm Resistor for LED strip

10k ohm Resistor for push button 

100uF 25V Capacitor for potentiometer

24 AWG solid wire for most connections

20 AWG flexible wire for connection cord

Battery Holder for 3 x 1.5V AA batteries with On/Off switch

Project Box (80 x 50x 26 mm)

Two Types of heat shrink tubing

Airsoft Face Mask

White Plastic Film Diffuser for mask cover
...
In the call function of each unique pattern that calls on customPattern() [e.g. ustomScrollingRowPattern() ] there’s a function that randomly chooses between the available palettes every 10 seconds.
